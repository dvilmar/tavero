    ...
    <div className="flex items-center justify-center gap-3">
      {links.map((link) => (
        <a
          ...
          className="w-11 h-11 rounded-full bg-bg border border-border flex items-center justify-center text-muted hover:text-accent hover:border-accent/40 transition-colors"
        >
          {link.icon}
        </a>
      ))}
